...
public class M3U8Utils {
     ...
     * @throws IOException
     */
    public static M3U8 parseNetworkM3U8Info(String parentUrl, String videoUrl, Map<String, String> headers, int retryCount,boolean needSign) throws IOException {
        InputStreamReader inputStreamReader = null;
        BufferedReader bufferedReader = null;
        try {
            if (needSign){
                videoUrl = PpvodUtil.getNewUrl(videoUrl);
            }
            ...
            if (responseCode == HttpUtils.RESPONSE_503 && retryCount < HttpUtils.MAX_RETRY_COUNT) {
                return parseNetworkM3U8Info(parentUrl, videoUrl, headers, retryCount + 1,needSign);
            }
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                if (hasMasterList) {
                    ...
                    return parseNetworkM3U8Info(parentUrl, tempUrl, headers, retryCount,needSign);
                }
