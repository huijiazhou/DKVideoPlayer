    ...
    public void sendResponse(Socket socket, OutputStream outputStream) throws VideoCacheException {
        ...
        try {
            if (mResponseState == null) {
                LogUtils.d(TAG, "mResponseState null");
            ...
            LogUtils.d(TAG, "PrintWriter support");
        ...
        LogUtils.d(TAG, "sendBodyWithCorrectTransferAndEncoding support");
            outputStream.flush();
        LogUtils.d(TAG, "flush support");
        } catch (Exception e) {
            e.printStackTrace();
